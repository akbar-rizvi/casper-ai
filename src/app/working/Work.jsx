    ...
    <div className='mt-20 min-h-[100vh] bg-black/3'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4 lg:grid-cols-4'>
            ...
            <div className='w-auto bg-white p-4 rounded-lg shadow-sm'>
                ...
                <Image src="/note1.png" alt="logo" width={100} height={10} className='flex-1 animate-[bounce_5s_ease-in-out_infinite] ' />
                </div>
            </div>
            <div className='w-auto bg-white p-4 rounded-lg shadow-sm'>
            ...
            <div className='w-auto bg-white p-4 rounded-lg shadow-sm'>
                ...
                <Image src="/avatar.png" alt="logo" width={110} height={110} className='flex-1  animate-[bounce_5s_ease-in-out_infinite] ' />
                </div>
            </div>
        ...
        <div className=' w-full flex flex-col items-center  justify-center  md:flex-row md:items-center md:justify-around md:gap-2 p-4 gap-2'>
           <div className='flex flex-col items-center gap-2'>
             <Image src="/idea.gif" alt="logo" width={200} height={200} className='rounded-full'/>
            <p className='text-sm'>Uplaod your ideas and content  or generate with Buxa.ai</p>
           </div>
            
                <Image src="/right-arrow.gif" alt="logo" width={50} height={50} className='rounded-full rotate-90 md:rotate-0'/>
                
           

       <div className='flex flex-col items-center gap-2'>
              <Image src="/social-media.gif" alt="logo" width={200} height={200} className='rounded-full '/>
              <p  className='text-sm'>Choose the platform you wamts to optimsie for.</p>
       </div>
              <Image src="/right-arrow.gif" alt="logo" width={50} height={50} className='rounded-full rotate-90 md:rotate-0'/>

             <div className='flex flex-col items-center gap-2'>
                 <Image src="/goal.gif" alt="logo" width={200} height={200} className='rounded-full'/>
