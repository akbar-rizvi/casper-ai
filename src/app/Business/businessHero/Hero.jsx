...
const BuusinessHero = () => {
  ...
  return (
   <div className="">
      ...
      <div className=" w-full flex flex-col sm:flex-row sm:items-center sm:justify-center rounded-md  gap-0 -mt-6">
      ...
      <div
        ...
        data-aos="fade-up">
  <p className="md:mt-10 "><span className="text-3xl text-blue-800 font-bold ">Hey</span> <span className="text-3xl font-bold ">Business</span></p>
  <p className="text-3xl font-bold">Owners !</p>
  <p className="px-5 text-center">
    According to HubSpot data, 47% of buyers view three to five content pieces before contacting sales representatives,
  </p>
</div>
